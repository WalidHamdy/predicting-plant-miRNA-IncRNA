...
# ListData_train = 'Training-validation-dataset/premli/pemg-mli-3200.fasta'   
#ListData_train = 'Training-validation-dataset/premli/pemg-mli-3200.fasta'   
ListData_train = 'trainingdata/pemg_7680.fasta'   
#ListData_train = 'trainingdata/train_8000.fasta'   
ListTrain = open(ListData_train, 'r').readlines()


# ListData_test = 'Training-validation-dataset/premli/pemg-mli-800.fasta'   
# ListData_test = 'Training-validation-dataset/pmlipred/3000.fasta'   
#ListData_test = 'Training-validation-dataset/imbalance8-2/pemg_imb800.fasta'   
ListData_test = 'testdata/imbalance/im_test1056.fasta'   
...
model_ensemble.compile(loss='categorical_crossentropy', optimizer=GTO, metrics=['accuracy'])
